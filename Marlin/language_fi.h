...
#define MSG_PREHEAT_3                       _UxGT("Esilämmitä CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Esilämmitä CFPC ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Esilä. CFPC Kaikki")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Esilä. ABS Alusta")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Esilämm. CFPC konf")
#define MSG_PREHEAT_4                       _UxGT("Esilämmitä PC")
#define MSG_PREHEAT_4_N                     _UxGT("Esilämmitä PC ")
#define MSG_PREHEAT_4_ALL                   _UxGT("Esilä. PC Kaikki")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Esilä. PC Alusta")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Esilämm. PC konf")
