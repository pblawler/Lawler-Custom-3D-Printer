...
#define MSG_PREHEAT_3                       _UxGT("Pre-aquecer CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Pre-aquecer CFPC ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Pre-aq. CFPC Tudo")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Pre-aq. CFPC ") LCD_STR_THERMOMETER _UxGT("Base")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Definições CFPC")
#define MSG_PREHEAT_4                       _UxGT("Pre-aquecer PC")
#define MSG_PREHEAT_4_N                     _UxGT("Pre-aquecer PC ")
#define MSG_PREHEAT_4_ALL                   _UxGT("Pre-aq. PC Tudo")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Pre-aq. PC ") LCD_STR_THERMOMETER _UxGT("Base")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Definições PC")
