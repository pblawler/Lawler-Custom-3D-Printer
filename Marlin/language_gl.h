...
#define MSG_PREHEAT_3                       _UxGT("Prequentar CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Prequentar CFPC ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Preque. CFPC Todo")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Preque. CFPC Cama")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Preque. CFPC conf")
#define MSG_PREHEAT_4                       _UxGT("Prequentar PC")
#define MSG_PREHEAT_4_N                     _UxGT("Prequentar PC ")
#define MSG_PREHEAT_4_ALL                   _UxGT("Preque. PC Todo")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Preque. PC Cama")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Preque. PC conf")
