...
#define MSG_PREHEAT_3                       _UxGT("Нагрів CFPC")
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT(" Все")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT(" Стіл")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT(" нал.")
#define MSG_PREHEAT_4                       _UxGT("Нагрів PC")
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT(" Все")
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4 _UxGT(" Стіл")
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_4 _UxGT(" нал.")
