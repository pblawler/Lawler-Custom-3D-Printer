...
#define MSG_PREHEAT_3                       _UxGT("Preescalfa CFPC")
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT(" Tot")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT(" Llit")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT(" Conf.")
#define MSG_PREHEAT_4                       _UxGT("Preescalfa PC")
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_2 _UxGT(" ")
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_2 _UxGT(" Tot")
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_2 _UxGT(" Llit")
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_2 _UxGT(" Conf.")
