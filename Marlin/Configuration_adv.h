...
#define TEMP_SENSOR_AD8495_OFFSET -251.1
#define TEMP_SENSOR_AD8495_GAIN   (10/6.6) // May need to set to 10/6.6 for 5v vcc
 ...
 */
   ...
   */
    ...
    #define SENSORLESS_HOMING // TMC2130 only
      ...
      //#define Z_HOMING_SENSITIVITY  8 //BLtouch is used for Z
    #endif
  #endif
  /**
