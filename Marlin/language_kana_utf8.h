...
#define MSG_PREHEAT_3                       _UxGT("CFPC ヨネツ")                  // "Preheat ABS"
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   _UxGT("CFPC スベテヨネツ")              // " All"
#define MSG_PREHEAT_3_BEDONLY               _UxGT("CFPC ベッドヨネツ")              // " Bed"
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT("セッテイ")       // " conf"
#define MSG_PREHEAT_4                       _UxGT("PC ヨネツ")                  // "Preheat ABS"
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")
#define MSG_PREHEAT_4_ALL                   _UxGT("PC スベテヨネツ")              // " All"
#define MSG_PREHEAT_4_BEDONLY               _UxGT("PC ベッドヨネツ")              // " Bed"
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_4 _UxGT("セッテイ")       // " conf"
