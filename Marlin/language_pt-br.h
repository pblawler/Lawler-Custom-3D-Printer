...
#define MSG_PREHEAT_3_ALL                   _UxGT("Pre-aq.Todo CFPC")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Pre-aq.Mesa CFPC")
#define MSG_PREHEAT_3_END                   _UxGT("Pre-aq.Extrusora")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Ajustar CFPC")
#define MSG_PREHEAT_4                       _UxGT("Pre-aquecer PC")
#define MSG_PREHEAT_4_N                     _UxGT("Pre-aquecer PC")
#define MSG_PREHEAT_4_ALL                   _UxGT("Pre-aq.Todo PC")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Pre-aq.Mesa PC")
#define MSG_PREHEAT_4_END                   _UxGT("Pre-aq.Extrusora")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Ajustar PC")
