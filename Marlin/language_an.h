...
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT(" Base")
...
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT(" Tot")
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4 _UxGT(" Base")
