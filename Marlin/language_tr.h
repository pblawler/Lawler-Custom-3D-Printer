...
#define MSG_PREHEAT_3                       _UxGT("Ön Isınma CFPC")                                      // Ön Isınma ABS
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")                                    //
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT(" Tüm")                                 //  Tüm
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3 _UxGT(" Nozül")                               //  Nozül
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT(" Tabla")                               //  Tabla
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT(" Ayar")                                //  Ayar
#define MSG_PREHEAT_4                       _UxGT("Ön Isınma PC")                                      // Ön Isınma ABS
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")                                    //
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT(" Tüm")                                 //  Tüm
#define MSG_PREHEAT_4_END                   MSG_PREHEAT_4 _UxGT(" Nozül")                               //  Nozül
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4 _UxGT(" Tabla")                               //  Tabla
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_4 _UxGT(" Ayar")                                //  Ayar
