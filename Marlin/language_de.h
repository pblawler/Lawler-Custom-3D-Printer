...
#define MSG_PREHEAT_3                       _UxGT("Vorwärmen CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Vorwärmen CFPC ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Vorw. CFPC Alle")
#define MSG_PREHEAT_3_END                   _UxGT("Vorw. CFPC Extr.")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Vorw. CFPC Bett")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Vorw. CFPC Einst.")
#define MSG_PREHEAT_4                       _UxGT("Vorwärmen PC")
#define MSG_PREHEAT_4_N                     _UxGT("Vorwärmen PC ")
#define MSG_PREHEAT_4_ALL                   _UxGT("Vorw. PC Alle")
#define MSG_PREHEAT_4_END                   _UxGT("Vorw. PC Extr.")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Vorw. PC Bett")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Vorw. PC Einst.")
