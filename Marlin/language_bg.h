...
#define MSG_PREHEAT_3                       _UxGT("Подгряване CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Подгряване CFPC")
#define MSG_PREHEAT_3_ALL                   _UxGT("Подгр. CFPC Всички")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Подгр. CFPC Легло")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Настройки CFPC")
#define MSG_PREHEAT_4                       _UxGT("Подгряване PC")
#define MSG_PREHEAT_4_N                     _UxGT("Подгряване PC")
#define MSG_PREHEAT_4_ALL                   _UxGT("Подгр. PC Всички")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Подгр. PC Легло")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Настройки PC")
