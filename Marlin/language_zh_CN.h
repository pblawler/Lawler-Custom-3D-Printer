...
#define MSG_PREHEAT_3                       _UxGT("预热CFPC")  //"Preheat CFPC"
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")  //MSG_PREHEAT_3 " "
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT(" 全部")  //MSG_PREHEAT_3 " All"
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT(" 热床")  //MSG_PREHEAT_3 " Bed"
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT(" 设置")  //MSG_PREHEAT_3 " conf"
#define MSG_PREHEAT_4                       _UxGT("预热PC")  //"Preheat PC"
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")  //MSG_PREHEAT_4 " "
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT(" 全部")  //MSG_PREHEAT_4 " All"
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4 _UxGT(" 热床")  //MSG_PREHEAT_4 " Bed"
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_4 _UxGT(" 设置")  //MSG_PREHEAT_4 " conf"
