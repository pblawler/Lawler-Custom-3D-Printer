...
#define MSG_PREHEAT_3                       _UxGT("Προθέρμανση CFPC")
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT(" όλα")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT(" bed") //SHORTEN
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT(" επιβεβαίωση") //SHORTEN
#define MSG_PREHEAT_4                       _UxGT("Προθέρμανση PC")
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT(" όλα")
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4 _UxGT(" bed") //SHORTEN
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_4 _UxGT(" επιβεβαίωση") //SHORTEN
