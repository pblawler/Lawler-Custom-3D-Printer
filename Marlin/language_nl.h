...
#define MSG_PREHEAT_3                       _UxGT("CFPC voorverwarmen")
#define MSG_PREHEAT_3_N                     _UxGT("CFPC voorverw. ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3_N _UxGT("aan")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3 _UxGT(" Einde")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3_N _UxGT("Bed")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("CFPC verw. conf")
#define MSG_PREHEAT_4                       _UxGT("PC voorverwarmen")
#define MSG_PREHEAT_4_N                     _UxGT("PC voorverw. ")
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4_N _UxGT("aan")
#define MSG_PREHEAT_4_END                   MSG_PREHEAT_4 _UxGT(" Einde")
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4_N _UxGT("Bed")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("PC verw. conf")
