...
#define MSG_PREHEAT_3                       _UxGT("Rozgrzej CFPC")
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT(" wsz.")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Rozgrzej stół CFPC")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Ustaw. rozg. CFPC")
#define MSG_PREHEAT_4                       _UxGT("Rozgrzej PC")
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT(" wsz.")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Rozgrzej stół PC")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Ustaw. rozg. PC")
