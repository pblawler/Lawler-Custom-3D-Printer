...
#define MSG_PREHEAT_3                       _UxGT("Forvarm CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Forvarm CFPC ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Forvarm CFPC Alle")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Forvarm CFPC Bed")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Forvarm CFPC conf")
#define MSG_PREHEAT_4                       _UxGT("Forvarm PC")
#define MSG_PREHEAT_4_N                     _UxGT("Forvarm PC ")
#define MSG_PREHEAT_4_ALL                   _UxGT("Forvarm PC Alle")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Forvarm PC Bed")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Forvarm PC conf")
