...
#define MSG_PREHEAT_2_ALL                   MSG_PREHEAT_2 _UxGT(" Guztia")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2 _UxGT(" Amaia")
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2 _UxGT(" Ohea")
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2 _UxGT(" Ezarp.")
#define MSG_PREHEAT_3                       _UxGT("Berotu CFPC")
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT(" Guztia")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3 _UxGT(" Amaia")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT(" Ohea")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT(" Ezarp.")
#define MSG_PREHEAT_4                       _UxGT("Berotu PC")
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT(" Guztia")
#define MSG_PREHEAT_4_END                   MSG_PREHEAT_4 _UxGT(" Amaia")
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4 _UxGT(" Ohea")
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_4 _UxGT(" Ezarp.")
