...
#define MSG_PREHEAT_3                       _UxGT("Prechauffage CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Prechauff. CFPC ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Prech. CFPC Tout")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3 _UxGT(" buse")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Prech. CFPC lit")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Regl. prech. CFPC")
#define MSG_PREHEAT_4                       _UxGT("Prechauffage PC")
#define MSG_PREHEAT_4_N                     _UxGT("Prechauff. PC ")
#define MSG_PREHEAT_4_ALL                   _UxGT("Prech. PC Tout")
#define MSG_PREHEAT_4_END                   MSG_PREHEAT_4 _UxGT(" buse")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Prech. PC lit")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Regl. prech. PC")
