...
#define MSG_PREHEAT_3                       _UxGT("Precalentar CFPC")
#define MSG_PREHEAT_3_N                     MSG_PREHEAT_3 _UxGT(" ")
#define MSG_PREHEAT_3_ALL                   MSG_PREHEAT_3 _UxGT("Todo")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3 _UxGT(" End")
#define MSG_PREHEAT_3_BEDONLY               MSG_PREHEAT_3 _UxGT("Plataforma")
#define MSG_PREHEAT_3_SETTINGS              MSG_PREHEAT_3 _UxGT("Config")
#define MSG_PREHEAT_4                       _UxGT("Precalentar PC")
#define MSG_PREHEAT_4_N                     MSG_PREHEAT_4 _UxGT(" ")
#define MSG_PREHEAT_4_ALL                   MSG_PREHEAT_4 _UxGT("Todo")
#define MSG_PREHEAT_4_END                   MSG_PREHEAT_4 _UxGT(" End")
#define MSG_PREHEAT_4_BEDONLY               MSG_PREHEAT_4 _UxGT("Plataforma")
#define MSG_PREHEAT_4_SETTINGS              MSG_PREHEAT_4 _UxGT("Config")
