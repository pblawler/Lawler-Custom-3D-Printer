...
typedef struct SettingsDataStruct {
  ...
  //
    ...
    int16_t lcd_preheat_hotend_temp[4],                   // M145 S0 H
            lcd_preheat_bed_temp[4],                      // M145 S0 B
            lcd_preheat_fan_speed[4];                     // M145 S0 F
...
void MarlinSettings::postprocess() {
  ...
  bool MarlinSettings::save() {
    ...
    _FIELD_TEST(lcd_preheat_hotend_temp);
        ...
        constexpr int16_t lcd_preheat_hotend_temp[4] = { PREHEAT_1_TEMP_HOTEND, PREHEAT_2_TEMP_HOTEND, PREHEAT_3_TEMP_HOTEND, PREHEAT_4_TEMP_HOTEND },
                          lcd_preheat_bed_temp[3] = { PREHEAT_1_TEMP_BED, PREHEAT_2_TEMP_BED, PREHEAT_3_TEMP_BED, PREHEAT_4_TEMP_BED },
                          lcd_preheat_fan_speed[3] = { PREHEAT_1_FAN_SPEED, PREHEAT_2_FAN_SPEED, PREHEAT_3_FAN_SPEED, PREHEAT_4_FAN_SPEED };
    #endif
  ...
  bool MarlinSettings::_load() {
    ...
    if (strncmp(version, stored_ver, 3) != 0) {
      ...
      #if DISABLED(ULTIPANEL)
        int16_t lcd_preheat_hotend_temp[4], lcd_preheat_bed_temp[4], lcd_preheat_fan_speed[4];
      #endif
      EEPROM_READ(lcd_preheat_hotend_temp); // 4 floats
      EEPROM_READ(lcd_preheat_bed_temp);    // 4 floats
      EEPROM_READ(lcd_preheat_fan_speed);   // 4 floats
