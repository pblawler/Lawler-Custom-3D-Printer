...
#define MSG_PREHEAT_3                       _UxGT("Préchauffage CFPC")
#define MSG_PREHEAT_3_N                     _UxGT("Préchauff. CFPC ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Préch. CFPC Tout")
#define MSG_PREHEAT_3_END                   MSG_PREHEAT_3 _UxGT(" buse")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Préch. CFPC lit")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Régl. prech. CFPC")
#define MSG_PREHEAT_4                       _UxGT("Préchauffage PC")
#define MSG_PREHEAT_4_N                     _UxGT("Préchauff. PC ")
#define MSG_PREHEAT_4_ALL                   _UxGT("Préch. PC Tout")
#define MSG_PREHEAT_4_END                   MSG_PREHEAT_4 _UxGT(" buse")
#define MSG_PREHEAT_4_BEDONLY               _UxGT("Préch. PC lit")
#define MSG_PREHEAT_4_SETTINGS              _UxGT("Régl. prech. PC")
